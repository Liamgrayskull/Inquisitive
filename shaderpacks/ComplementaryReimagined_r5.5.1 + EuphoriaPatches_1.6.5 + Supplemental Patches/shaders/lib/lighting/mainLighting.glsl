...
void DoLighting(inout vec4 color, inout vec3 shadowMult, vec3 playerPos, vec3 viewPos, float lViewPos, vec3 geoNormal, vec3 normalM, float dither,
    ...
    vec3 blockLighting = lightmapXM * blocklightCol;
        ...
        float heldLight = heldBlockLightValue; float heldLight2 = heldBlockLightValue2;
            ...
            if (heldItemId == 46084) heldLight = 15; if (heldItemId == 46084) heldLight2 = 15; // golden_lava_bucket
            if (heldItemId == 46176) heldLight = 7; if (heldItemId == 46176) heldLight2 = 7; // ectoplasm_bucket
            if (heldItemId == 46204) heldLight = 8; if (heldItemId == 46204) heldLight2 = 8; // molten_lead_bucket
            if (heldItemId == 46228) heldLight = 10; if (heldItemId == 46228) heldLight2 = 10; // lumisene_bucket
            if (heldItemId == 46232) heldLight = 8; if (heldItemId == 46232) heldLight2 = 8; // glow_squid_bucket
            ...
            if (heldItemId == 46084) { heldLightCol = lavaSpecialLightColor.rgb; heldLight = 15; };  // golden_lava_bucket
            if (heldItemId2 == 46084) { heldLightCol2 = lavaSpecialLightColor.rgb; heldLight2 = 15; };
            if (heldItemId == 46176) { heldLightCol = vec4(soulFireSpecialColor.rgb * 4.0, 0.10).rgb; heldLight = 7; };  // ectoplasm_bucket
            if (heldItemId2 == 46176) { heldLightCol2 = vec4(soulFireSpecialColor.rgb * 4.0, 0.10).rgb; heldLight2 = 7; };
            if (heldItemId == 46204) { heldLightCol = vec4(vec3(0.48, 0.48, 1.0) * 2.5, 0.0).rgb; heldLight = 8; };  // molten_lead_bucket
            if (heldItemId2 == 46204) { heldLightCol2 = vec4(vec3(0.48, 0.48, 1.0) * 2.5, 0.0).rgb; heldLight2 = 8; };
            if (heldItemId == 46228) { heldLightCol = vec4(7.40, 3.50, 2.60, 0.0).rgb; heldLight = 10; };  // lumisene_bucket
            if (heldItemId2 == 46228) { heldLightCol2 = vec4(7.40, 3.50, 2.60, 0.0).rgb; heldLight2 = 10; };
            if (heldItemId == 46232) { heldLightCol = soulFireSpecialColor.rgb; heldLight = 8; };  // glow_squid_bucket
            if (heldItemId2 == 46232) { heldLightCol2 = soulFireSpecialColor.rgb; heldLight2 = 8; };
